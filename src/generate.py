...
def generate_with_sampling(model, tokenizer, prompt, max_new_tokens=200, temperature=0.3, top_k=20, top_p=0.9):
    """使用改进采样策略的生成函数"""
    model.eval()
...
def main():
    ...
    parser.add_argument('--temperature', type=float, default=0.3, help='生成温度 (0.1-1.0)')
